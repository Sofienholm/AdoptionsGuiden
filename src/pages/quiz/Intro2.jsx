  ...
  return (
    <div className="min-h-screen bg-[#F6F0E8] flex flex-col items-center justify-center px-10 text-center">
      ...
      <button
        ...
        className="fixed bottom-10 right-10 bg-[#FF4F3C] text-white  font-knewave w-28 h-28 rounded-full md:w-32 md:h-32 flex items-center justify-center text-lg md:text-xl shadow-lg hover:scale-105 transition-transform"
      >
        START
      </button>
    </div>
